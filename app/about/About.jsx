...
const About = () => {
  return (
    <section className="relative w-full min-h-[600px] max-lg:pt-16 bg-white overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 lg:pt-20 flex flex-col lg:flex-row items-center gap-10 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2 z-10 order-2 lg:order-1">
          <h2 className="text-3xl md:text-4xl lg:text-6xl font-[Lato] font-bold text-[#0056B3] leading-tight mb-6">
            Reliable, Affordable & Eco-Friendly Hygiene Solutions
          </h2>

          <p className="text-gray-600 text-base md:text-lg mb-8 md:mb-10 max-w-xl leading-relaxed">
          ...
          <div className="space-y-5 md:space-y-6">
            {[
              ...
              <div key={index} className="flex items-start gap-3 md:gap-4">
                <CheckCircle2 className="w-5 h-5 md:w-6 md:h-6 text-[#0056B3] flex-shrink-0 mt-1" />
        ...
        <div className="w-full lg:w-1/2 relative order-1 lg:order-2 flex justify-center">
          {/* Main Image Container - Height scales based on device */}
