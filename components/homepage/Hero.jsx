...
const HeroSection = () => {
  ...
  // Motion variants for staged text entries
  ...
  return (
    ...
    <section 
      ...
      className="relative w-full min-h-screen overflow-hidden flex items-center py-20 lg:py-20"
    >
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <motion.div 
            ...
            className="z-10 w-full lg:max-w-2xl text-center lg:text-left order-2 lg:order-1"
          >
            <motion.div variants={fadeInUpVariants} className="flex items-center justify-center lg:justify-start gap-2 mb-4">
            ...
            <motion.div variants={fadeInUpVariants}>
              {title.includes("India's") ? (
                <h1 
                  ...
                  className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-[1.1] mb-6 text-[#0056B3]"
                >
                  India&apos;s{" "}
            ...
            <motion.div variants={fadeInUpVariants} className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
          ...
          <div className={`relative w-full lg:w-1/2 flex justify-center items-center mt-8 lg:mt-0 ${heroData?.image_position === 'left' ? 'order-1 lg:order-1' : 'order-1 lg:order-2'}`}>
            ...
            <div className="relative z-10 w-full max-w-[350px] sm:max-w-[450px] md:max-w-[550px] lg:max-w-full">
              ...
              <motion.div 
                ...
                className="absolute top-[10%] -left-2 md:-left-8 bg-white px-3 py-1.5 md:px-5 md:py-2.5 rounded-full shadow-xl border border-gray-100 block"
              > 
              ...
              <motion.div 
                ...
                className="absolute bottom-[15%] -right-2 md:-right-8 bg-white px-3 py-1.5 md:px-5 md:py-2.5 rounded-full shadow-xl border border-gray-100 block"
              > 
